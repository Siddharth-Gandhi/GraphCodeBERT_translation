...
def main():
    ...
    if args.do_test:
        ...
        for idx,file in enumerate(files):
            ...
            with open(os.path.join(args.output_dir,"test_{}.metrics".format(str(idx))),'w') as f:
                f.write("bleu-4:"+str(dev_bleu)+'\n')
                f.write("xMatch:"+str(round(np.mean(accs)*100,4))+'\n')
                f.write("bleu-4+xMatch:"+str(dev_bleu+round(np.mean(accs)*100,4))+'\n')
